...
var myExcalSheet = function myExcalSheet(opts) {
  if(!opts) opts = {};
  ...
  function sheetjsw(data, cb, readtype) {
    ...
    for (var i = 0; i < scripts.length; i++) {
      if (scripts[i].src.indexOf('myExcalSheet') != -1) {
        //dropsheetPath = scripts[i].src.split('myExcalSheet.js')[0];
		dropsheetPath = scripts[i].src.split('js/myExcalSheet.js')[0];
      }
    }
